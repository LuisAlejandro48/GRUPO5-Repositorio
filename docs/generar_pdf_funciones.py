...
HTML_FILE = ROOT / "funciones_reciclaje11.html"
PDF_FILE = ROOT / "funciones_reciclaje11.pdf"
...
def texto_desde_html(source):
    ...
    raw = re.sub(r"<h3><code>(.*?)</code></h3>", r"\n### \1\n", raw, flags=re.S)
...
def cortar_lineas(lines):
    ...
    for line in lines:
        ...
        if not line:
            ...
            result.append((line[4:], "function"))
        else:
            for part in textwrap.wrap(line, width=96):
